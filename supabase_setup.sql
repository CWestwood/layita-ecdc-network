...
\restrict LKyRG52A89uEjBAA6pUhiTR9c2ccHzGhnqbRg2eZQSIDNeRe0czcWd30rwNPZfk
...
CREATE OR REPLACE FUNCTION "public"."find_similar_practitioners"("search_name" "text") RETURNS TABLE("id" "uuid", "name" "text", "ecdc_name" "text", "similarity" double precision)
    LANGUAGE "sql"
    AS $$
  select p.id, p.name, e.name as ecdc_name,
         similarity(lower(p.name), lower(search_name)) as similarity
  from practitioners p
  left join ecdc_list e on e.id = p.ecdc_id
  where similarity(lower(p.name), lower(search_name)) > 0.4
  order by similarity desc;
$$;


ALTER FUNCTION "public"."find_similar_practitioners"("search_name" "text") OWNER TO "postgres";
...
DECLARE
  ...
  key text;
BEGIN
  -- Convert the old and new SQL rows into JSON objects
  old_json := to_jsonb(OLD);
  new_json := to_jsonb(NEW);

  -- Loop through every column to find what changed
  FOR key IN SELECT jsonb_object_keys(new_json)
  LOOP
    -- If the value changed (and isn't just the 'updated_at' timestamp)
    IF old_json->key IS DISTINCT FROM new_json->key AND key != 'updated_at' THEN
      
      -- Build a JSON object showing old vs new, e.g., {"old": "123", "new": "456"}
...
CREATE OR REPLACE FUNCTION "public"."merge_practitioners"("keep_id" "uuid", "discard_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
begin
...
ALTER TABLE "public"."ecdc_list" OWNER TO "postgres";


COMMENT ON TABLE "public"."ecdc_list" IS 'ECDCs registered with SmartStart/Layita';



COMMENT ON COLUMN "public"."ecdc_list"."chief" IS 'The local chief';



COMMENT ON COLUMN "public"."ecdc_list"."headman" IS 'The local headman';



COMMENT ON COLUMN "public"."ecdc_list"."number_children" IS 'Number of children at the ECDC';
...
CREATE TABLE IF NOT EXISTS "public"."groups" (
    ...
    "organisation" "text" DEFAULT 'Smartstart'::"text",
    "area_id" "uuid"
);
...
ALTER TABLE "public"."kobo_label" OWNER TO "postgres";
...
ALTER TABLE "public"."kobo_processed" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."kobotoolbox_ecdc_export" AS
 SELECT ("e"."id")::"text" AS "name",
   ...
   FROM (("public"."ecdc_list" "e"
     LEFT JOIN "public"."practitioners" "p" ON (("p"."ecdc_id" = "e"."id")))
...
COMMENT ON TABLE "public"."landmarks" IS 'Local Landmarks for mapping';



ALTER TABLE "public"."landmarks" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."landmarks_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."layita_staff" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."training" (
    "id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "smart_start_ever" boolean,
    "first_aid_ever" boolean,
    "level4_ever" boolean,
    "level5_ever" boolean,
    "wordworks03_ever" boolean,
    "wordworks35_ever" boolean,
    "littlestars_ever" boolean,
    "other" "text"
);
...
COMMENT ON TABLE "public"."training" IS 'Training received by practitioners';



CREATE TABLE IF NOT EXISTS "public"."visit_requirements" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "area_id" "uuid" DEFAULT "gen_random_uuid"(),
    "minimum_visits_per_year" smallint DEFAULT '1'::smallint
);


ALTER TABLE "public"."visit_requirements" OWNER TO "postgres";


COMMENT ON TABLE "public"."visit_requirements" IS 'Sets out the organisational targets for number of visits per facility per year';
...
ALTER TABLE ONLY "public"."ecdc_list"
    ADD CONSTRAINT "ecdc_list_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."kobo_label"
    ADD CONSTRAINT "kobo_choices_list_name_name_key" UNIQUE ("list_name", "name");



ALTER TABLE ONLY "public"."kobo_label"
    ADD CONSTRAINT "kobo_label_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."kobo_processed"
    ADD CONSTRAINT "kobo_processed_pkey" PRIMARY KEY ("instance_id");



ALTER TABLE ONLY "public"."kobo_raw_submissions"
    ADD CONSTRAINT "kobo_raw_submissions_pkey" PRIMARY KEY ("instance_id");



ALTER TABLE ONLY "public"."kobo_unmatched"
    ADD CONSTRAINT "kobo_unmatched_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."layita_staff"
    ADD CONSTRAINT "layita_staff_name_key" UNIQUE ("name");



ALTER TABLE ONLY "public"."layita_staff"
    ADD CONSTRAINT "layita_staff_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."visit_requirements"
    ADD CONSTRAINT "visit_requirements_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "ecdc_list_location_idx" ON "public"."ecdc_list" USING "gist" ("location");



CREATE INDEX "kobo_choices_list_name_idx" ON "public"."kobo_label" USING "btree" ("list_name");
...
CREATE OR REPLACE TRIGGER "ecdc_audit_trigger" AFTER UPDATE ON "public"."ecdc_list" FOR EACH ROW EXECUTE FUNCTION "public"."log_table_updates"();
...
ALTER TABLE ONLY "public"."ecdc_list"
    ADD CONSTRAINT "ecdc_list_area_id_fkey" FOREIGN KEY ("area_id") REFERENCES "public"."area"("id") ON UPDATE CASCADE ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."groups"
    ADD CONSTRAINT "groups_area_id_fkey" FOREIGN KEY ("area_id") REFERENCES "public"."area"("id") ON UPDATE CASCADE ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."kobo_unmatched"
    ADD CONSTRAINT "kobo_unmatched_instance_id_fkey" FOREIGN KEY ("instance_id") REFERENCES "public"."kobo_raw_submissions"("instance_id");
...
ALTER TABLE ONLY "public"."outreach_visits"
    ADD CONSTRAINT "outreach_visits_kobo_instance_id_fkey" FOREIGN KEY ("kobo_instance_id") REFERENCES "public"."kobo_raw_submissions"("instance_id") ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."practitioners"
    ADD CONSTRAINT "practitioners_ecdc_id_fkey" FOREIGN KEY ("ecdc_id") REFERENCES "public"."ecdc_list"("id") ON UPDATE CASCADE ON DELETE SET NULL;



ALTER TABLE ONLY "public"."practitioners"
    ADD CONSTRAINT "practitioners_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "public"."groups"("id") ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."training"
    ADD CONSTRAINT "training_id_fkey" FOREIGN KEY ("id") REFERENCES "public"."practitioners"("id") ON UPDATE CASCADE ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."visit_requirements"
    ADD CONSTRAINT "visit_requirements_area_id_fkey" FOREIGN KEY ("area_id") REFERENCES "public"."area"("id") ON UPDATE CASCADE ON DELETE RESTRICT;
...
\unrestrict LKyRG52A89uEjBAA6pUhiTR9c2ccHzGhnqbRg2eZQSIDNeRe0czcWd30rwNPZfk
